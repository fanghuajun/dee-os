 ...
 <el-collapse v-model="activeNames">
    ...
    <el-row style="margin:5px">
        ...
        <template v-if="type === 'customer'">
          <el-button size="small" type="primary">分配分销商<i class="el-icon-news"></i></el-button>
          <el-button size="small" type="primary">变更时间<i class="el-icon-date"></i></el-button>
          <el-button size="small" type="primary">变更历史<i class="el-icon-view"></i></el-button>
        </template>
        <template v-else>
           <el-button size="small" type="primary">审核<i class="el-icon-success"></i></el-button>
        </template>
        <el-button size="small" type="primary">收款<i class="el-icon-goods"></i></el-button>    
        <el-button size="small" type="primary">查询收款<i class="el-icon-share"></i></el-button>
    </el-row>        
        <el-table
        :data="tableData"
