 ...
 <el-collapse v-model="activeNames">
    <el-collapse-item title="" name="1">
      <el-form :inline="true" :model="searitem" class="demo-form-inline" size="mini">
        <el-form-item  label="编码">
          <el-input v-model="searitem.number" placeholder="编码"></el-input>
      </el-form-item>
        <el-form-item :span="4" label="名称">
          <el-input v-model="searitem.name" placeholder="名称"></el-input>
        </el-form-item>
        <el-form-item :span="4">
    ...
    <el-row style="margin:5px">
        ...
        size="small"
        style="width: 100%">
        <el-table-column fixed sortable prop="number" label="编码" width="120"></el-table-column>
        <el-table-column fixed sortable prop="name" label="名称"  width="120"></el-table-column>
    ...
    <el-dialog
      ...
      :before-close="handleClose">
       <el-form :inline="true" :model="comtype" class="demo-form-inline">
          <el-form-item  label="站点编码">
            <el-input v-model="comtype.number" placeholder="站点编码"></el-input>
          </el-form-item>
          <el-form-item  label="站点名称">
            <el-input v-model="comtype.name" placeholder="站点名称"></el-input>
         </el-form-item>
       </el-form>
