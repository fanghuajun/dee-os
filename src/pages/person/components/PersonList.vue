 ...
 <el-collapse v-model="activeNames">
    <el-collapse-item title="" name="1">
      <el-form :inline="true" :model="searitem" class="demo-form-inline" size="mini">
        <el-form-item  label="人员编码">
          <el-input v-model="searitem.number" placeholder="人员名称"></el-input>
      </el-form-item>
        <el-form-item :span="4" label="人员名称">
          <el-input v-model="searitem.name" placeholder="人员名称"></el-input>
        </el-form-item>
        <el-form-item :span="4">
    ...
    <el-row style="margin:5px">
        ...
        size="small"
        style="width: 100%">
        <el-table-column fixed sortable prop="number" label="人员编码" width="120"></el-table-column>
        <el-table-column fixed sortable prop="name" label="人员名称"  width="120"></el-table-column>
        <el-table-column prop="accountNo" label="账号"  width="120"></el-table-column>
        <el-table-column prop="accountName" label="账号名称" width="180"></el-table-column>
         <el-table-column prop="mobile" label="电话" width="180"></el-table-column>
        <el-table-column prop="address" label="家庭地址" width="180"></el-table-column>
        <el-table-column prop="defaultrole" label="默认角色" width="180"></el-table-column>
